...
app.directive('ionicDatepicker', ['$ionicPopup', 'DatepickerService', function ($ionicPopup, DatepickerService) {
  return {
    ...
    link: function (scope, element, attrs) {
      ...
      scope.currentMonth = '';
      scope.currentYear = '';
      scope.maxDate = DatepickerService.maxDate ;
      scope.minDate = DatepickerService.minDate ;

      //scope.disablePreviousDates = DatepickerService.minDate ? true : false;
      ...
      scope.previousDayEpoch =   scope.disablePreviousDates ? new Date(scope.disablePreviousDates).getTime()  :   0 ;
      
      scope.nextDate = scope.maxDate ?  scope.maxDate.getTime()  : 0 ;
      ...
      var refreshDateList = function (current_date) {
        ...
        scope.lastDate = scope.dayList[scope.dayList.length - 1].epochLocal;
        ...
        scope.date_selection.selectedDate = new Date(current_date);
      ...
      function setChangeedInput(){
        var yearObj = document.getElementById("selectYear");
        var monthObj = document.getElementById("selectMonth");
        yearObj.options[ scope.yearsList.indexOf(scope.currentYear) ].selected = true ;
        monthObj.options[ currentDate.getMonth()].selected = true ;
      }
